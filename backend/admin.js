    ...
    lines.forEach((line) => {
      ...
      if (selectedGroup === "controllers") {
        ...
        group().items.push({
          ...
          avg: cleanNum(cols[5]),
          module_size: cols[6] || "",
          cabinet_resolution: cols[7] || "",
          modules_per_cabinet: cleanNum(cols[8]),
          weight_kg: cleanNum(cols[9]),
          brightness: cleanNum(cols[10]),
          refresh_rate: cleanNum(cols[11]),
          material: cols[12] || "",
          maintenance: cols[13] || "",
          ingress_protection: cols[14] || "",
          led_type: cols[15] || "",
          beam_angle: cols[16] || "",
          color_temperature: cols[17] || "",
          processing_depth: cols[18] || "",
          life_hours: cleanNum(cols[19]),
          video_support: cols[20] || "",
          display_type: cols[21] || "",
